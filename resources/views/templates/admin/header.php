...
<head>
    ...
    <link href="../public/dist/admin.min.css?ver=<?php echo filemtime( HLEB_GLOBAL_DIR . '/public/dist/admin.min.css' );?>" rel="stylesheet" type="text/css" />
    ...
    <script src="../public/dist/admin.min.js?ver=<?php echo filemtime( HLEB_GLOBAL_DIR . '/public/dist/admin.min.js' );?>" defer></script>
